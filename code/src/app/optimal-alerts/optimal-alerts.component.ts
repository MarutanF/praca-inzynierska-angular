...
@Component({
  selector: 'app-optimal-alerts',
  templateUrl: './optimal-alerts.component.html',
  styleUrls: ['./optimal-alerts.component.css']
})
export class OptimalAlertsComponent implements OnInit {
